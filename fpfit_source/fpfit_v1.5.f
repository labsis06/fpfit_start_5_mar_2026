...
c      revisions in V1.5:
c                   1.  For Hypoinverse, code supports:
c                       reversed channel list requires location code and channel code
...
10    call input (eunit, funit, iunit, punit, sunit, lopen2,
     ...
     & kilnet, revnet, dbg, ncmpnt, okcmp, macsrc, nmsrc, hndsrc, 
     & nhsrc, revloc, revchn)
c
      ievp = 0
      ievr = 0
