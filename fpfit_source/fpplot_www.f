...
c
c	parameter (cx1 = 4.20)
c	parameter (cx2 = 9.0)
c	parameter (cy1 = 3.70)
c	parameter (cy2 = 1.55)
c	parameter (ndiscm = 36)
c	parameter (rmax1 = 2.95)
c	parameter (xpos1 = 0.3)
c	parameter (xpos2 = 8.2)
c	parameter (ypos2 = 0.6)
c	parameter (ypos3 = 6.5)
c	parameter (www = .false.)
